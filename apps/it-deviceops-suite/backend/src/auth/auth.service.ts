...
export class AuthService {
  ...
  private async buildAuthResult(user: User, ipAddress: string | null, userAgent: string | null) {
  ...
  async login(data: LoginUserDto, ipAddress: string | null = null, userAgent: string | null = null) {
    ...
    return this.buildAuthResult(user, ipAddress, userAgent);
  }

  async loginWithEmail(email: string, ipAddress: string | null = null, userAgent: string | null = null) {
    const user = await this.userRepository.findOne({
