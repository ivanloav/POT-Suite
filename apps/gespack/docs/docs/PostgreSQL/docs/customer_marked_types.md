...
| CLIENTE             | customer_id      | BIGINT          | Cliente asociado             |
| SITE_ID             | site_id          | BIGINT          | Site asociado                |
...
```sql
INSERT INTO customer_marked_types (customer_id, site_id, name, description, created_by)
VALUES (1, 1, 'ROBINSON', 'Cliente con exclusión publicitaria', 'admin');
```
