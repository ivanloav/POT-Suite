...
```sql
INSERT INTO products (site_id, reference, catalog, action, description, weight, vat, picking_location, storage_location, packaging, price, units_per_pack, stock, cost, additional_info, vat_type, created_by, created_at, modified_by, updated_at, status, blocked_stock, is_shipped_by_supplier)
